                    ...
                    foreach ($order_items as $order_item_id => $order_item){
                        ...
                        foreach ($reservations_data as $reservation_data){
                            $DOPBSP->classes->backend_reservation->add($reservation_data->calendar_id,
                                                                       ...
                                                                       array(
                                                                            array("id" => 1, "is_email" => "false", "add_to_day_hour_info" => "false", "add_to_day_hour_body" => "false","translation" => $DOPBSP->text('FORMS_DEFAULT_FIRST_NAME'), "value" => $user_meta['billing_first_name'][0]),
                                                                            array("id" => 2, "is_email" => "false", "add_to_day_hour_info" => "false", "add_to_day_hour_body" => "false","translation" => $DOPBSP->text('FORMS_DEFAULT_LAST_NAME'), "value" => $user_meta['billing_last_name'][0]),
                                                                            array("id" => 3, "is_email" => "true", "add_to_day_hour_info" => "false", "add_to_day_hour_body" => "false","translation" => $DOPBSP->text('FORMS_DEFAULT_EMAIL'), "value" => $user_meta['billing_email'][0]),
                                                                            array("id" => 4, "is_email" => "false", "add_to_day_hour_info" => "false", "add_to_day_hour_body" => "false","translation" => $DOPBSP->text('FORMS_DEFAULT_PHONE'), "value" => $user_meta['billing_phone'][0]),
